...
exports.propertySetsDeclaration = exports.propertyDeclaration = exports.interfaceDeclaration = void 0;
...
function propertyDeclaration(generator, { fieldName, type, propertyName, typeName, description, isInput, isArray, isNullable, isArrayElementNullable }, closure) {
    ...
    if (closure) {
        ...
        const typeString = `: ${typeName || type && (0, types_1.typeNameFromGraphQLType)(generator.context, type)}`;
