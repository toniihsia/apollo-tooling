...
function argumentsFromAST(args) {
    return (args &&
        args.map(arg => {
            return { name: arg.name.value, value: (0, graphql_2.valueFromValueNode)(arg.value) };
        }));
}
...
class Compiler {
    ...
    addTypeUsed(type) {
        ...
        if (type instanceof graphql_1.GraphQLEnumType ||
            ...
            (type instanceof graphql_1.GraphQLScalarType && !(0, graphql_2.isBuiltInScalarType)(type))) {
