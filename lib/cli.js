...
yargs
    ...
    if (urlRegex.test(schema)) {
        await (0, _1.downloadSchema)(schema, output, header, insecure, method);
    }
    else {
        await (0, _1.introspectSchema)(schema, output);
    }
})
    ...
    await (0, _1.printSchema)(schema, output);
})
    ...
    (0, _1.generate)(inputPaths, argv.schema, argv.output, argv.target, argv.tagName, options);
})
