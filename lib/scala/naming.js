...
function propertyFromField(context, field, namespace) {
    ...
    if ((0, graphql_1.isCompositeType)(bareType)) {
        const bareTypeName = (0, printing_1.join)([
            namespace,
        ...
        const typeName = (0, types_1.typeNameFromGraphQLType)(context, type, undefined, isOptional);
...
function propertyFromInlineFragment(context, inlineFragment) {
    ...
    const propertyName = (0, change_case_1.camelCase)(structName);
...
function propertyFromFragmentSpread(context, fragmentSpread) {
    ...
    const propertyName = (0, change_case_1.camelCase)(fragmentName);
