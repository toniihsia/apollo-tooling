...
exports.getFieldDef = exports.getOperationRootType = exports.isTypeProperSuperTypeOf = exports.valueFromValueNode = exports.filePathForNode = exports.sourceAt = exports.withTypenameFieldAddedWhereNeeded = exports.isMetaFieldName = exports.isBuiltInScalarType = exports.isList = void 0;
...
function isTypeProperSuperTypeOf(schema, maybeSuperType, subType) {
    return (0, graphql_1.isEqualType)(maybeSuperType, subType) || subType instanceof graphql_1.GraphQLObjectType && ((0, graphql_1.isAbstractType)(maybeSuperType) && schema.isPossibleType(maybeSuperType, subType));
}
